...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunPush;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_PUSH;

public class AqlFunPushImpl extends ASTWrapperPsiElement implements AqlFunPush {

  public AqlFunPushImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunPush(this);
  }
  ...
  public PsiElement getFPush() {
    return findNotNullChildByType(F_PUSH);
  }
