...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunTranslate;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_TRANSLATE;

public class AqlFunTranslateImpl extends ASTWrapperPsiElement implements AqlFunTranslate {

  public AqlFunTranslateImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getFTranslate() {
    return findNotNullChildByType(F_TRANSLATE);
  }
