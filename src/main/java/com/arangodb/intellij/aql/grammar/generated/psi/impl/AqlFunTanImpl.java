...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunTan;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_TAN;

public class AqlFunTanImpl extends ASTWrapperPsiElement implements AqlFunTan {

  public AqlFunTanImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunTan(this);
  }
  ...
  public PsiElement getFTan() {
    return findNotNullChildByType(F_TAN);
  }
