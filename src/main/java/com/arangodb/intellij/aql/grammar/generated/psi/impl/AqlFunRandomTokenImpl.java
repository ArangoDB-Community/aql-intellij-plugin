...
public class AqlFunRandomTokenImpl extends ASTWrapperPsiElement implements AqlFunRandomToken {

  public AqlFunRandomTokenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunRandomToken(this);
  }
  ...
  public PsiElement getFRandomToken() {
    return findNotNullChildByType(F_RANDOM_TOKEN);
  }
