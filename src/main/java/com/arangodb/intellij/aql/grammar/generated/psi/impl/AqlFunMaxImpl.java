...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunMax;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_MAX;

public class AqlFunMaxImpl extends ASTWrapperPsiElement implements AqlFunMax {

  public AqlFunMaxImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunMax(this);
  }
  ...
  public PsiElement getFMax() {
    return findNotNullChildByType(F_MAX);
  }
