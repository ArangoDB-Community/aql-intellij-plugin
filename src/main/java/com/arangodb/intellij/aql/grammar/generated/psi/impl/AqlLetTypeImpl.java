...
public class AqlLetTypeImpl extends ASTWrapperPsiElement implements AqlLetType {

  public AqlLetTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitLetType(this);
  }
  ...
  public PsiElement getTLet() {
    return findNotNullChildByType(T_LET);
  }
