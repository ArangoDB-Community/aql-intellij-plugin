...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunMin;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_MIN;

public class AqlFunMinImpl extends ASTWrapperPsiElement implements AqlFunMin {

  public AqlFunMinImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunMin(this);
  }
  ...
  public PsiElement getFMin() {
    return findNotNullChildByType(F_MIN);
  }
