...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunCount;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_COUNT;

public class AqlFunCountImpl extends ASTWrapperPsiElement implements AqlFunCount {

  public AqlFunCountImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunCount(this);
  }
  ...
  public PsiElement getFCount() {
    return findNotNullChildByType(F_COUNT);
  }
