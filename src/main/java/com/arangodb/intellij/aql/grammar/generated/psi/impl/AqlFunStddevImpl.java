...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunStddev;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_STDDEV;

public class AqlFunStddevImpl extends ASTWrapperPsiElement implements AqlFunStddev {

  public AqlFunStddevImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunStddev(this);
  }
  ...
  public PsiElement getFStddev() {
    return findNotNullChildByType(F_STDDEV);
  }
