...
public class AqlFunSoundexImpl extends ASTWrapperPsiElement implements AqlFunSoundex {

  public AqlFunSoundexImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunSoundex(this);
  }
  ...
  public PsiElement getFSoundex() {
    return findNotNullChildByType(F_SOUNDEX);
  }
