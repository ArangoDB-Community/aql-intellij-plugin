...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunSin;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_SIN;

public class AqlFunSinImpl extends ASTWrapperPsiElement implements AqlFunSin {

  public AqlFunSinImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunSin(this);
  }
  ...
  public PsiElement getFSin() {
    return findNotNullChildByType(F_SIN);
  }
