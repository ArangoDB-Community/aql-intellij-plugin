...
public class AqlFunIpToNumberImpl extends ASTWrapperPsiElement implements AqlFunIpToNumber {

  public AqlFunIpToNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunIpToNumber(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getFIpv4ToNumber() {
    return findNotNullChildByType(F_IPV4_TO_NUMBER);
  }
