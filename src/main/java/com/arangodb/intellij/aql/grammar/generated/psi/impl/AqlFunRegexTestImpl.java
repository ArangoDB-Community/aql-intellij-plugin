...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunRegexTest;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_REGEX_TEST;

public class AqlFunRegexTestImpl extends ASTWrapperPsiElement implements AqlFunRegexTest {

  public AqlFunRegexTestImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunRegexTest(this);
  }
  ...
  public PsiElement getFRegexTest() {
    return findNotNullChildByType(F_REGEX_TEST);
  }
