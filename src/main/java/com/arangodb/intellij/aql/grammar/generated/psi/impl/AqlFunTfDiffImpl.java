...
public class AqlFunTfDiffImpl extends ASTWrapperPsiElement implements AqlFunTfDiff {

    public AqlFunTfDiffImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull AqlVisitor visitor) {
        visitor.visitFunTfDiff(this);
    }
    ...
    public PsiElement getFTfidf() {
        return findNotNullChildByType(F_TFIDF);
    }
