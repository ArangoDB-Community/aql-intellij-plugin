...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunFindFirst;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_FIND_FIRST;

public class AqlFunFindFirstImpl extends ASTWrapperPsiElement implements AqlFunFindFirst {

  public AqlFunFindFirstImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunFindFirst(this);
  }
  ...
  public PsiElement getFFindFirst() {
    return findNotNullChildByType(F_FIND_FIRST);
  }
