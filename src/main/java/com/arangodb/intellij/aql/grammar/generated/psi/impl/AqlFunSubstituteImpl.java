...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunSubstitute;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_SUBSTITUTE;

public class AqlFunSubstituteImpl extends ASTWrapperPsiElement implements AqlFunSubstitute {

  public AqlFunSubstituteImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunSubstitute(this);
  }
  ...
  public PsiElement getFSubstitute() {
    return findNotNullChildByType(F_SUBSTITUTE);
  }
