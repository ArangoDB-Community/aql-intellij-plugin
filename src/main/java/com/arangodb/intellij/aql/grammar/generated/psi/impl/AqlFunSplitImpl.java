...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunSplit;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_SPLIT;

public class AqlFunSplitImpl extends ASTWrapperPsiElement implements AqlFunSplit {

  public AqlFunSplitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunSplit(this);
  }
  ...
  public PsiElement getFSplit() {
    return findNotNullChildByType(F_SPLIT);
  }
