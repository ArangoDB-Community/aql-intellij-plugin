...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunRegexMatches;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_REGEX_MATCHES;

public class AqlFunRegexMatchesImpl extends ASTWrapperPsiElement implements AqlFunRegexMatches {

  public AqlFunRegexMatchesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunRegexMatches(this);
  }
  ...
  public PsiElement getFRegexMatches() {
    return findNotNullChildByType(F_REGEX_MATCHES);
  }
