...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunUnsetRecursive;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_UNSET_RECURSIVE;

public class AqlFunUnsetRecursiveImpl extends ASTWrapperPsiElement implements AqlFunUnsetRecursive {

  public AqlFunUnsetRecursiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunUnsetRecursive(this);
  }
