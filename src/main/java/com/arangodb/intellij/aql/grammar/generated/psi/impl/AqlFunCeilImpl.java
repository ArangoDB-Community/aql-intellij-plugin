...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunCeil;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_CEIL;

public class AqlFunCeilImpl extends ASTWrapperPsiElement implements AqlFunCeil {

  public AqlFunCeilImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunCeil(this);
  }
  ...
  public PsiElement getFCeil() {
    return findNotNullChildByType(F_CEIL);
  }
