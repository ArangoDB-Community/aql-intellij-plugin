...
public class AqlFunMinMatchImpl extends ASTWrapperPsiElement implements AqlFunMinMatch {

    public AqlFunMinMatchImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull AqlVisitor visitor) {
        visitor.visitFunMinMatch(this);
    }
    ...
    public PsiElement getFMinMatch() {
        return findNotNullChildByType(F_MIN_MATCH);
    }
