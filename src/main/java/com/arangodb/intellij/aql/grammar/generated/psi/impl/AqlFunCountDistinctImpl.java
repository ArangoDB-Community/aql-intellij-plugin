...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunCountDistinct;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_COUNT_DISTINCT;

public class AqlFunCountDistinctImpl extends ASTWrapperPsiElement implements AqlFunCountDistinct {

  public AqlFunCountDistinctImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunCountDistinct(this);
  }
  ...
  public PsiElement getFCountDistinct() {
    return findNotNullChildByType(F_COUNT_DISTINCT);
  }
