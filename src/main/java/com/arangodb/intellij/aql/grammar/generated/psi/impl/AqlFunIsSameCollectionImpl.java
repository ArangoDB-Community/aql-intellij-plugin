...
public class AqlFunIsSameCollectionImpl extends ASTWrapperPsiElement implements AqlFunIsSameCollection {

  public AqlFunIsSameCollectionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunIsSameCollection(this);
  }
  ...
  public PsiElement getFIsSameCollection() {
    return findNotNullChildByType(F_IS_SAME_COLLECTION);
  }
