...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunUnionDistinct;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_UNION_DISTINCT;

public class AqlFunUnionDistinctImpl extends ASTWrapperPsiElement implements AqlFunUnionDistinct {

  public AqlFunUnionDistinctImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunUnionDistinct(this);
  }
  ...
  public PsiElement getFUnionDistinct() {
    return findNotNullChildByType(F_UNION_DISTINCT);
  }
