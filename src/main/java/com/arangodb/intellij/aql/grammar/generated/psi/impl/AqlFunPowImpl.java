...
public class AqlFunPowImpl extends ASTWrapperPsiElement implements AqlFunPow {

    public AqlFunPowImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull AqlVisitor visitor) {
        visitor.visitFunPow(this);
    }
    ...
    public PsiElement getFPow() {
        return findNotNullChildByType(F_POW);
    }
