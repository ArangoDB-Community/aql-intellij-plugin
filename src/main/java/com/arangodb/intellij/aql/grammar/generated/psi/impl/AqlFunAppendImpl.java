...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunAppend;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_APPEND;

public class AqlFunAppendImpl extends ASTWrapperPsiElement implements AqlFunAppend {

  public AqlFunAppendImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunAppend(this);
  }
  ...
  public PsiElement getFAppend() {
    return findNotNullChildByType(F_APPEND);
  }
