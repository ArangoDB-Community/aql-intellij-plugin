...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunContains;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_CONTAINS;

public class AqlFunContainsImpl extends ASTWrapperPsiElement implements AqlFunContains {

  public AqlFunContainsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunContains(this);
  }
  ...
  public PsiElement getFContains() {
    return findNotNullChildByType(F_CONTAINS);
  }
