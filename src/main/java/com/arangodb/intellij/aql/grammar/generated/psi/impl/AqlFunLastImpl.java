...
import com.arangodb.intellij.aql.grammar.generated.psi.AqlFunLast;
...
import static com.arangodb.intellij.aql.grammar.generated.psi.AqlTypes.F_LAST;

public class AqlFunLastImpl extends ASTWrapperPsiElement implements AqlFunLast {

  public AqlFunLastImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AqlVisitor visitor) {
    visitor.visitFunLast(this);
  }
  ...
  public PsiElement getFLast() {
    return findNotNullChildByType(F_LAST);
  }
