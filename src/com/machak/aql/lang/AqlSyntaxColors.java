...
public final class AqlSyntaxColors {
    ...
    public static final TextAttributesKey BAD_CHARACTER = createTextAttributesKey("AQL_BAD_CHARACTER", HighlighterColors.BAD_CHARACTER);
    ...
    public static final TextAttributesKey SEMICOLON = createTextAttributesKey("AQL_SEMICOLON", DefaultLanguageHighlighterColors.SEMICOLON);
